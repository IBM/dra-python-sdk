...
class DrAutomationServiceV1(BaseService):
    ...
    def get_powervs_workspaces(
        ...
        **kwargs,
        ...
        Retrieves the Power Virtual Server workspaces associated with the primary and
        standby orchestrators for the given instance ID and location ID.
    ...
    def create_manage_dr(
        ...
        *,
        ...
        managed_apikey: Optional[str] = None,
        client_id: Optional[str] = None,
        client_secret: Optional[str] = None,
        guid: Optional[str] = None,
        orchestrator_ha: Optional[bool] = None,
        orchestrator_network_ids: Optional[List[str]] = None,
        ...
        standby_orchestrator_network_ids: Optional[List[str]] = None,
        standby_ssh_key_name: Optional[str] = None,
        ...
        **kwargs,
        ...
        :param str managed_apikey: (optional) APIKey used to manage the workloads
               by adding the PowerVS instances to the orchestrator.
        ...
        :param List[str] orchestrator_network_ids: (optional) List of network IDs
               for primary orchestrator VM.
        :param str orchestrator_workspace_location: (optional) The location of the
        ...
        :param str secondary_workspace_id: (optional) The unique identifier of the
               secondary workspace used for the disaster recovery.
        ...
        :param List[str] standby_orchestrator_network_ids: (optional) List of
               network IDs for standby orchestrator VM.
        :param str standby_ssh_key_name: (optional) The name of the SSH key used
               for deploying the standby orchestator.
        :param str standby_orchestrator_workspace_id: (optional) The unique
               identifier of the standby orchestrator workspace.
        :param str standby_orchestrator_workspace_location: (optional) The location
               of the standby orchestrator workspace.
...
class OrchestratorDetails:
    ...
    :param str standby_orchestrator_workspace_name: The name of the standby
          orchestrator workspace.
    :param str standby_ssh_key_name: SSH key name used for the standby orchestrator.
    ...
    def __init__(
        ...
        *,
        ...
        :param str standby_orchestrator_workspace_name: The name of the standby
               orchestrator workspace.
        :param str standby_ssh_key_name: SSH key name used for the standby
               orchestrator.
        :param str transit_gateway_name: The name of the transit gateway.
        :param str vpc_name: The name of the VPC.
        ...
        self.standby_ssh_key_name = standby_ssh_key_name
    ...
    def from_dict(cls, _dict: Dict) -> 'OrchestratorDetails':
        ...
        if (standby_ssh_key_name := _dict.get('standby_ssh_key_name')) is not None:
            args['standby_ssh_key_name'] = standby_ssh_key_name
        else:
            raise ValueError('Required property \'standby_ssh_key_name\' not present in OrchestratorDetails JSON')
    ...
    def to_dict(self) -> Dict:
        ...
        if hasattr(self, 'standby_ssh_key_name') and self.standby_ssh_key_name is not None:
            _dict['standby_ssh_key_name'] = self.standby_ssh_key_name
...
class ServiceInstanceManageDR:
    ...
    :param str id: (optional) The CRN (Cloud Resource Name) of the DR service
          instance.
    :param str orchestrator_location_type: (optional) The cloud location where your
          orchestator need to be created.
    :param str location_id: (optional) The location or data center identifier where
          the service instance is deployed.
    :param str ssh_key_name: (optional) The name of the SSH key used for deploying
          the orchestator.
    :param str standby_ssh_key_name: (optional) The name of the SSH key used for
          deploying the standby orchestator.
    :param str orchestrator_name: (optional) The username used for the orchestrator.
    :param str orchestrator_workspace_id: (optional) The unique identifier
          orchestrator workspace.
    :param str standby_orchestrator_name: (optional) The username for the standby
          orchestrator management interface.
    :param str standby_orchestrator_workspace_id: (optional) The unique identifier
          of the standby orchestrator workspace.
    :param bool orchestrator_ha: (optional) Indicates whether the orchestrator High
          Availability (HA) is enabled for the service instance.
    :param str resource_instance: (optional) The uniquie identifier of the
          associated IBM Cloud resource instance.
    :param str secret_group: (optional) The secret group name in IBM Cloud Secrets
          Manager containing sensitive data for the service instance.
    :param str secret: (optional) The secret name or identifier used for retrieving
          credentials from secrets manager.
    :param str region_id: (optional) The power virtual server region where the
          service instance is deployed.
    :param str guid: (optional) The global unique identifier of the service
          instance.
    :param str machine_type: (optional) The machine type used for deploying
          orchestrator.
    :param str tier: (optional) The storage tier used for deploying primary
          orchestrator.
    :param str standby_tier: (optional) The storage tier used for deploying standby
          orchestrator.
    :param str standby_machine_type: (optional) The machine type used for deploying
          standby virtual machines.
    :param str tenant_name: (optional) The tenant name for MFA authentication API.
    :param str proxy_ip: (optional) Proxy IP for the Communication between
          Orchestrator and Service broker.
    """
    ...
    def __init__(
        ...
        *,
        ...
        :param str id: (optional) The CRN (Cloud Resource Name) of the DR service
               instance.
        :param str orchestrator_location_type: (optional) The cloud location where
               your orchestator need to be created.
        :param str location_id: (optional) The location or data center identifier
               where the service instance is deployed.
        :param str ssh_key_name: (optional) The name of the SSH key used for
               deploying the orchestator.
        :param str standby_ssh_key_name: (optional) The name of the SSH key used
               for deploying the standby orchestator.
        :param str orchestrator_name: (optional) The username used for the
               orchestrator.
        :param str orchestrator_workspace_id: (optional) The unique identifier
               orchestrator workspace.
        :param str standby_orchestrator_name: (optional) The username for the
        ...
        self.standby_ssh_key_name = standby_ssh_key_name
        self.orchestrator_name = orchestrator_name
        self.orchestrator_workspace_id = orchestrator_workspace_id
        self.standby_orchestrator_name = standby_orchestrator_name
        self.standby_orchestrator_workspace_id = standby_orchestrator_workspace_id
        self.orchestrator_ha = orchestrator_ha
        ...
        self.tier = tier
        self.standby_tier = standby_tier
        self.standby_machine_type = standby_machine_type
    ...
    def from_dict(cls, _dict: Dict) -> 'ServiceInstanceManageDR':
        ...
        if (orchestrator_name := _dict.get('orchestrator_name')) is not None:
            args['orchestrator_name'] = orchestrator_name
        if (orchestrator_workspace_id := _dict.get('orchestrator_workspace_id')) is not None:
            args['orchestrator_workspace_id'] = orchestrator_workspace_id
        if (standby_orchestrator_name := _dict.get('standby_orchestrator_name')) is not None:
            args['standby_orchestrator_name'] = standby_orchestrator_name
        if (standby_orchestrator_workspace_id := _dict.get('standby_orchestrator_workspace_id')) is not None:
            args['standby_orchestrator_workspace_id'] = standby_orchestrator_workspace_id
        if (orchestrator_ha := _dict.get('orchestrator_ha')) is not None:
            args['orchestrator_ha'] = orchestrator_ha
        if (resource_instance := _dict.get('resource_instance')) is not None:
            args['resource_instance'] = resource_instance
        if (secret_group := _dict.get('secret_group')) is not None:
            args['secret_group'] = secret_group
        ...
        if (guid := _dict.get('guid')) is not None:
            args['guid'] = guid
        if (machine_type := _dict.get('machine_type')) is not None:
            args['machine_type'] = machine_type
        if (tier := _dict.get('tier')) is not None:
            args['tier'] = tier
        if (standby_tier := _dict.get('standby_tier')) is not None:
            args['standby_tier'] = standby_tier
        if (standby_machine_type := _dict.get('standby_machine_type')) is not None:
            args['standby_machine_type'] = standby_machine_type
        if (tenant_name := _dict.get('tenant_name')) is not None:
    ...
    def to_dict(self) -> Dict:
        ...
        if hasattr(self, 'orchestrator_name') and self.orchestrator_name is not None:
            _dict['orchestrator_name'] = self.orchestrator_name
        if hasattr(self, 'orchestrator_workspace_id') and self.orchestrator_workspace_id is not None:
            _dict['orchestrator_workspace_id'] = self.orchestrator_workspace_id
        if hasattr(self, 'standby_orchestrator_name') and self.standby_orchestrator_name is not None:
            _dict['standby_orchestrator_name'] = self.standby_orchestrator_name
        if hasattr(self, 'standby_orchestrator_workspace_id') and self.standby_orchestrator_workspace_id is not None:
            _dict['standby_orchestrator_workspace_id'] = self.standby_orchestrator_workspace_id
        if hasattr(self, 'orchestrator_ha') and self.orchestrator_ha is not None:
            _dict['orchestrator_ha'] = self.orchestrator_ha
        if hasattr(self, 'resource_instance') and self.resource_instance is not None:
            _dict['resource_instance'] = self.resource_instance
        if hasattr(self, 'secret_group') and self.secret_group is not None:
            _dict['secret_group'] = self.secret_group
        ...
        if hasattr(self, 'tier') and self.tier is not None:
            _dict['tier'] = self.tier
        if hasattr(self, 'standby_tier') and self.standby_tier is not None:
            _dict['standby_tier'] = self.standby_tier
        if hasattr(self, 'standby_machine_type') and self.standby_machine_type is not None:
            _dict['standby_machine_type'] = self.standby_machine_type
        if hasattr(self, 'tenant_name') and self.tenant_name is not None:
            _dict['tenant_name'] = self.tenant_name
        if hasattr(self, 'proxy_ip') and self.proxy_ip is not None:
            _dict['proxy_ip'] = self.proxy_ip
        return _dict
...
class ServiceInstanceStatus:
    ...
    :param str orch_standby_node_addition_status: The status of standby node in the
    ...
    :param str primary_error_description: Capture the error while creating primary
          orchestrator.
    ...
    :param str standby_description: Indicates the progress details of primary
          orchestrator creation.
    :param str standby_error_description: Capture the error while creating standby
          orchestrator.
    ...
    :param bool is_api_key_expired: Indicates whether the API key used for the
    ...
    def __init__(
        ...
        resource_group: str,
        standby_description: str,
        standby_error_description: str,
        standby_ip_address: str,
        standby_status: str,
        status: str,
        is_api_key_expired: bool,
        *,
        ...
        :param str mfa_enabled: Indicated whether multi factor authentication is
               ennabled or not.
        :param str orch_standby_node_addition_status: The status of standby node in
        ...
        :param str primary_description: Indicates the progress details of primary
               orchestrator creation.
        :param str primary_error_description: Capture the error while creating
        ...
        :param str standby_description: Indicates the progress details of primary
               orchestrator creation.
        :param str standby_error_description: Capture the error while creating
               standby orchestrator.
        ...
        self.primary_error_description = primary_error_description
        self.primary_ip_address = primary_ip_address
        self.primary_orchestrator_status = primary_orchestrator_status
        self.recovery_location = recovery_location
        self.resource_group = resource_group
        self.standby_description = standby_description
        self.standby_error_description = standby_error_description
        self.standby_ip_address = standby_ip_address
        self.standby_status = standby_status
        self.status = status
        self.is_api_key_expired = is_api_key_expired
    ...
    def from_dict(cls, _dict: Dict) -> 'ServiceInstanceStatus':
        ...
        if (orch_standby_node_addition_status := _dict.get('orch_standby_node_addition_status')) is not None:
            ...
            raise ValueError(
                'Required property \'orch_standby_node_addition_status\' not present in ServiceInstanceStatus JSON'
            )
        if (orchestrator_cluster_message := _dict.get('orchestrator_cluster_message')) is not None:
            args['orchestrator_cluster_message'] = orchestrator_cluster_message
        else:
        ...
        if (primary_error_description := _dict.get('primary_error_description')) is not None:
            args['primary_error_description'] = primary_error_description
        else:
            raise ValueError(
                'Required property \'primary_error_description\' not present in ServiceInstanceStatus JSON'
            )
        if (primary_ip_address := _dict.get('primary_ip_address')) is not None:
            args['primary_ip_address'] = primary_ip_address
        else:
        ...
        if (standby_error_description := _dict.get('standby_error_description')) is not None:
            args['standby_error_description'] = standby_error_description
        else:
            raise ValueError(
                'Required property \'standby_error_description\' not present in ServiceInstanceStatus JSON'
            )
        if (standby_ip_address := _dict.get('standby_ip_address')) is not None:
            args['standby_ip_address'] = standby_ip_address
        else:
        ...
        if (is_api_key_expired := _dict.get('is_api_key_expired')) is not None:
            args['is_api_key_expired'] = is_api_key_expired
        else:
            raise ValueError('Required property \'is_api_key_expired\' not present in ServiceInstanceStatus JSON')
        return cls(**args)
    ...
    def to_dict(self) -> Dict:
        ...
        if hasattr(self, 'primary_error_description') and self.primary_error_description is not None:
            _dict['primary_error_description'] = self.primary_error_description
        if hasattr(self, 'primary_ip_address') and self.primary_ip_address is not None:
            _dict['primary_ip_address'] = self.primary_ip_address
        ...
        if hasattr(self, 'standby_description') and self.standby_description is not None:
            _dict['standby_description'] = self.standby_description
        if hasattr(self, 'standby_error_description') and self.standby_error_description is not None:
            _dict['standby_error_description'] = self.standby_error_description
        if hasattr(self, 'standby_ip_address') and self.standby_ip_address is not None:
            _dict['standby_ip_address'] = self.standby_ip_address
        if hasattr(self, 'standby_status') and self.standby_status is not None:
            _dict['standby_status'] = self.standby_status
        if hasattr(self, 'status') and self.status is not None:
            _dict['status'] = self.status
        if hasattr(self, 'is_api_key_expired') and self.is_api_key_expired is not None:
            _dict['is_api_key_expired'] = self.is_api_key_expired
        return _dict
