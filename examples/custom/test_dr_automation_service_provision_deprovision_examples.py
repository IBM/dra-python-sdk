...
class TestResourceControllerV2Examples:
    ...
    def test_create_resource_instance_with_parameters(self):
        ...
        try:
            ...
            child_result = catalog_service.get_child_objects(
                id=service_entry_id,
                kind="*",
                complete=True
            ).get_result()
            ...
            instance_details = resource_controller_service.get_resource_instance(
                id=created_instance_guid
            ).get_result()
    ...
    def test_delete_resource_instance(self):
        ...
        try:
            ...
            instance_guid = globals().get("created_instance_guid",
            ...
            delete_response = resource_controller_service.delete_resource_instance(
                id=instance_guid,
                recursive=False
            )
